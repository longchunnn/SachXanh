      ...
      <div className="min-h-screen flex flex-col bg-white">
        ...
        <footer className="py-6 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center text-sm border-t border-gray-100 bg-white gap-4">
          ...
          <div className="text-gray-400 text-xs">
            © {new Date().getFullYear()} Sách Xanh. Được thiết kế cho Độc giả Hiện đại.
          </div>
          <div className="flex gap-6 text-gray-500">
            <Link to="/privacy" className="hover:text-teal-700 transition-colors">Chính sách bảo mật</Link>
            <Link to="/terms" className="hover:text-teal-700 transition-colors">Điều khoản dịch vụ</Link>
            <Link to="/contact" className="hover:text-teal-700 transition-colors">Liên hệ</Link>
          </div>
        </footer>
      </div>
  );
